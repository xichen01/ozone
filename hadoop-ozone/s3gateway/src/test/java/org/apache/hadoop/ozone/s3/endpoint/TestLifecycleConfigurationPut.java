...
public class TestLifecycleConfigurationPut {
  ...
  public void testCreateInvalidLifecycleConfiguration() throws Exception {
    testInvalidLifecycleConfiguration(() -> onePrefix(false),
        HTTP_BAD_REQUEST, INVALID_REQUEST.getCode());
    testInvalidLifecycleConfiguration(this::usePrefixTagWithoutAndOperator,
        HTTP_BAD_REQUEST, MALFORMED_XML.getCode());
